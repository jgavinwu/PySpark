...
endScriptWithCommands()
{
    ...
    then 
       ...
       console "\"curl ${SS_CURL_OPTIONS} -X GET $(get_http_authentication) -H '$(get_http_instance_id)' https://${HOSTNAME}/tenant/data/${SS_SPARK_WORK_DIR}/${submissionId}/stdout > stdout_${EXECUTION_TIMESTAMP}\" \n"
       console "\"curl ${SS_CURL_OPTIONS} -X GET $(get_http_authentication) -H '$(get_http_instance_id)' https://${HOSTNAME}/tenant/data/${SS_SPARK_WORK_DIR}/${submissionId}/stderr > stderr_${EXECUTION_TIMESTAMP}\" \n"
